  ...
  (
    ...
    return (
      ...
      >
        ...
        <div
          className={cn(
            "duration-200 fixed inset-y-0 z-10 hidden h-svh w-[--sidebar-width] transition-[left,right,width] md:flex",
            side === "left"
        ...
        >
          <div
            data-sidebar="sidebar"
            className="flex h-full w-full flex-col bg-sidebar group-data-[variant=floating]:border-r group-data-[variant=floating]:border-sidebar-border group-data-[variant=floating]:bg-sidebar group-data-[variant=inset]:m-2 group-data-[variant=inset]:mb-2 group-data-[variant=inset]:rounded-lg group-data-[variant=inset]:border group-data-[variant=inset]:border-sidebar-border"
          >
            {children}
          </div>
        </div>
  ...
  return (
    <button
      ...
      className={cn(
        ...
        "group-data-[collapsible=offcanvas]:translate-x-12 group-data-[collapsible=offcanvas]:after:left-1/2",
  ...
  return (
    <main
      ...
      className={cn(
        ...
        "peer-data-[variant=inset]:min-h-[calc(100svh-2rem)]",
        className
      )}
      {...props}
    />
